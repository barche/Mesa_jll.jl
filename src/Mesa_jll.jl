...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Mesa_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("78dcde23-ec64-5e07-a917-6fe22bbc0f45"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Mesa", artifacts_toml) for e in artifacts["Mesa"]]
...
if best_platform === nothing
    @debug("Unable to load Mesa; unsupported platform $(triplet(platform_key_abi()))")
else
